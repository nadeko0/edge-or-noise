...
<p align="center">
  <img src="figures/permutation_test.png" width="90%" alt="Наблюдаемый AUC на фоне null-распределения из 60 прогонов с перемешанными метками — реальный результат стоит далеко за пределами того, куда попадают случайные метки.">
</p>
<p align="center">
  <img src="figures/auc_by_horizon.png" width="49%" alt="Столбчатая диаграмма: ROC-AUC падает с 0.669 на горизонте 1 минута до 0.580 на горизонте 10 минут.">
  <img src="figures/feature_importance.png" width="49%" alt="Горизонтальная диаграмма важности фичей XGBoost: реализованная волатильность и диапазон бара доминируют; фичи order flow — в самом низу.">
</p>
